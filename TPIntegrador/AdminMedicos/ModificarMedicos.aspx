<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarMedicos.aspx.cs" Inherits="TPIntegrador.AdminMedicos.ModificarMedicos" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="modal__content" runat="server" style="border-radius:30px">
            ...
            <div class="form-group">
                <div>
                    <label for="txtLegajo">Legajo:<br />
                    </label>
                    <asp:TextBox ID="txtLegajo" runat="server" Enabled="False" />
                </div>
                <div>
                    ...
                    &nbsp;<asp:TextBox ID="txtDNI" runat="server" Enabled="False" />
                </div>
                <div>
                ...
                <div class="date">
                    <label for="inputFecha">Fecha de Nacimiento:<label for="txtNacionalidad"><asp:RequiredFieldValidator ID="rfvFechanacimiento" runat="server" ControlToValidate="inputFecha" ErrorMessage="Ingrese una fecha de nacimiento." ForeColor="#FF3300" ValidationGroup="grupo1">*</asp:RequiredFieldValidator>
                    </label>
                    </label>
&nbsp;<input ID="inputFecha" type="date" runat="server" CssClass="TextBox"/>
                ...
                <div>
                    ...
                    <asp:RequiredFieldValidator ID="rfvTelefono" runat="server" ControlToValidate="txtTelefono" ErrorMessage="Ingrese un número de teléfono." ForeColor="#FF3300" ValidationGroup="grupo1">*</asp:RequiredFieldValidator>
                ...
                <div>
                    ...
                    <asp:CustomValidator ID="cvDias" runat="server" ErrorMessage="CustomValidator" ValidationGroup="grupo1"></asp:CustomValidator>
                    <br />
                ...
                <div>
                    ...
                    <asp:RequiredFieldValidator ID="rfvHorarios" runat="server" ControlToValidate="rblHorarios" ErrorMessage="Seleccione un horario." ForeColor="#FF3300" ValidationGroup="grupo1">*</asp:RequiredFieldValidator>
                    <br />
