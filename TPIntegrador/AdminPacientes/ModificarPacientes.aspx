<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarPacientes.aspx.cs" Inherits="TPIntegrador.AdminPacientes.ModificarPacientes" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="modal__content" runat="server" style="border-radius:30px">
            <h3  runat="server" style="font-size: 23px">
                <asp:Label ID="lblDialog" runat="server" Text="¿Estás seguro que deseas modificar este registro ?"></asp:Label>
            </h3>
            <asp:Button ID="btnAceptarDialog" runat="server"  Text="aceptar" Height="32px" Width="76px" CssClass="auto-style3" OnClick="btnAceptarDialog_Click" style="margin-top: 33px" />
             <asp:Button ID="btnCancelarDialog" runat="server" Text="Cancelar" Height="32px" Width="70px" OnClick="btnCancelarDialog_Click" CssClass="auto-style2" />
    ...
    <h3>Datos personales</h3>
        ...
        <div class="datos">
            ...
            <asp:RegularExpressionValidator ID="revDNI" runat="server" ControlToValidate="txtDNI" ErrorMessage="Ingrese un DNI válido." ForeColor="#FF3300" ValidationExpression="^[0-9]*$" ValidationGroup="grupo1">*</asp:RegularExpressionValidator>
             ...
             <asp:TextBox ID="txtDni"   runat="server" CssClass="auto-style1" Width="220px" Enabled="False"></asp:TextBox>
        ...
        <div class="datos">
            ...
            <asp:RequiredFieldValidator ID="rfvSexo0" runat="server" ControlToValidate="ddlProvincia" ErrorMessage="Seleccione una provincia." ForeColor="#FF3300" InitialValue="-- Seleccione Provincia --" ValidationGroup="grupo1">*</asp:RequiredFieldValidator>
            <asp:DropDownList ID="ddlLocalidad" runat="server" CssClass="auto-style1" Width="220px">
            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="rfvSexo1" runat="server" ControlToValidate="ddlLocalidad" ErrorMessage="Seleccione una localidad." ForeColor="#FF3300" InitialValue="-- Seleccione Localidad --" ValidationGroup="grupo1">*</asp:RequiredFieldValidator>
        </div>
        ...
        <div class="date">
            <p>Ingrese fecha de nacimiento: <label for="txtNacionalidad">
                    <asp:RequiredFieldValidator ID="rfvFechanacimiento" runat="server" ControlToValidate="fecha" ErrorMessage="Ingrese una fecha de nacimiento." ForeColor="#FF3300" ValidationGroup="grupo1">*</asp:RequiredFieldValidator>
                    </label>
            </p>
            <input type="date" runat="server" CssClass="TextBox" id="fecha"/>
        </div>
